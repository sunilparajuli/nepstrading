          ...
          Container(
            ...
            child: const Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                Text('Bank Name: Nepstrading', style: TextStyle(fontSize: 12, color: Colors.black87)),
                Text('B.S.B: 063-581', style: TextStyle(fontSize: 12, color: Colors.black87)),
                Text('Account Number: 10599057', style: TextStyle(fontSize: 12, color: Colors.black87)),
                Text('PayID: 0401596751', style: TextStyle(fontSize: 12, color: Colors.black87)),
              ],
            ),
          ),
        const SizedBox(height: 12),
